/**
 *Submitted for verification at hecoinfo.com on 2021-03-14
*/
...
contract LpStakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    IHecoPool public hecoPool = IHecoPool(0xFB03e11D93632D97a8981158A632Dd5986F5E909);
    IERC20 public mdxToken = IERC20(0x25D2e80cB6B86881Fd7e07dd263Fb79f4AbE033c);
...
contract LpStakingRewardsFactory is Ownable {
    ...
    function deploy(address operator, address stakingToken, uint rewardAmount, uint256 hecoPoolId, uint256 startTime) public onlyOwner {
        ...
        info.lpStakingRewards = address(new LpStakingRewards(/*_rewardsDistribution=*/ address(this), operator, rewardsToken, stakingToken, rewardAmount, hecoPoolId, startTime));
    ...
    function setHecoPool(address stakingToken, uint hecoPoolId) public onlyOwner {
        LpStakingRewardsInfo storage info = lpStakingRewardsInfoByStakingToken[stakingToken];
        require(info.lpStakingRewards != address(0), 'LpStakingRewardsFactory::setOperator: not deployed');
        LpStakingRewards(info.lpStakingRewards).setHecoPool(hecoPoolId);
    }
